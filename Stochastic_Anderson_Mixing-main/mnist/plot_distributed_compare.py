...
SERIES = [
    ("dsgd", "Distributed SGD", "#4C72B0"),
    ("dsam", "Distributed SAM", "#8172B2"),
]
...
def save_pil_figure(run_data, output_dir, title):
    ...
    image.save(output_dir / "distributed_compare.png")
...
def main():
    ...
    parser.add_argument("--title", type=str, default="Distributed SAM MNIST Comparison")
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig(args.output_dir / "distributed_compare.png", dpi=200, bbox_inches="tight")
        fig.savefig(args.output_dir / "distributed_compare.pdf", bbox_inches="tight")
        plt.close(fig)
    except Exception:
