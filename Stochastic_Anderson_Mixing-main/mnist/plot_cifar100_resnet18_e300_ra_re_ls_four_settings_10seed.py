...
OUT_DIR = BASE_DIR / "cifar100_resnet18_e300_ra_re_ls_four_settings_10seed_fig"
...
def result_path(setting_key, method_key, seed):
    return BASE_DIR / f"cifar100_resnet18_e300_ra_re_ls_{setting_key}_{method_key}_seed{seed}.pkl"
...
def plot_summary(rows):
    ...
    draw_center(
        ...
        width / 2,
        20,
        "CIFAR-100 / ResNet18 / 300e / RandAug+RE+LS, 10 Seeds",
        font,
    )
    ...
    png_path = OUT_DIR / "cifar100_resnet18_e300_ra_re_ls_four_settings_summary.png"
    pdf_path = OUT_DIR / "cifar100_resnet18_e300_ra_re_ls_four_settings_summary.pdf"
...
def plot_curves(all_results):
    ...
    draw = ImageDraw.Draw(image)
    font = ImageFont.load_default()
    draw_center(draw, width / 2, 20, "CIFAR-100 / ResNet18 Mean Curves, 10 Seeds", font)
    ...
    png_path = OUT_DIR / "cifar100_resnet18_e300_ra_re_ls_four_settings_curves.png"
    pdf_path = OUT_DIR / "cifar100_resnet18_e300_ra_re_ls_four_settings_curves.pdf"
    save_image(image, png_path, pdf_path)
    return png_path, pdf_path
