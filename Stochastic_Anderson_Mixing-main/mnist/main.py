...
from optim.adasam import AdaSAM
...
def main():
    ...
    parser.add_argument('--optimizer', type=str, default='adasam',
                        choices=['sgd', 'adagrad', 'rmsprop', 'adasam'],
                        help='optimizer to compare on the same MNIST subset experiment')
    parser.add_argument('--adasam-period', type=int, default=1)
    parser.add_argument('--adasam-hist-length', type=int, default=20)
    parser.add_argument('--adasam-alpha', type=float, default=1.0)
    parser.add_argument('--adasam-beta', type=float, default=1.0)
    parser.add_argument('--adasam-damp', type=float, default=1e-4)
    parser.add_argument('--adasam-gamma', type=float, default=0.9)
    parser.add_argument('--adasam-precision', type=int, default=1)
    ...
    if args.optimizer == 'sgd':
        ...
        base_optimizer = optim.SGD(model.parameters(), lr=args.lr, weight_decay=0, momentum=0)
        optimizer = AdaSAM(
            base_optimizer,
            period=args.adasam_period,
            hist_length=args.adasam_hist_length,
            alpha=args.adasam_alpha,
            beta=args.adasam_beta,
            gamma=args.adasam_gamma,
            damp=args.adasam_damp,
            precision=args.adasam_precision,
        )
