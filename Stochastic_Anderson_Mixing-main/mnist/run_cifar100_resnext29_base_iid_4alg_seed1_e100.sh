...
OUT_DIR="$ROOT/experiments/by_family/cifar100/resnext29/base_iid_e100_seed1_4alg"
...
launch_one() {
  ...
  local alg="$3"
  shift 3
  local prefix="by_family/cifar100/resnext29/base_iid_e100_seed1_4alg/${method}_seed"
...
launch_one 4 asyncsam_rms asyncsam "${ASYNCSAM_ARGS[@]}"
launch_one 5 asyncsgd asyncsgd
launch_one 6 fedasync fedasync "${FEDASYNC_ARGS[@]}"
launch_one 7 fedbuff fedbuff "${FEDBUFF_ARGS[@]}"
